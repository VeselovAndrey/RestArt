...
namespace RestArt.Convertors
{
    ...
    internal class ObjectConvertor
    {
        public IDictionary<string, object> ToObjectDictionary(object source)
        {
            ...
            Dictionary<string, object> dictionary = new Dictionary<string, object>(capacity: properties.Length);
        ...
        public IDictionary<string, string> ToStringDictionary(object source)
        {
            ...
            PropertyInfo[] properties = sourceType.GetProperties();
            Dictionary<string, string> dictionary = new Dictionary<string, string>(capacity: properties.Length);
